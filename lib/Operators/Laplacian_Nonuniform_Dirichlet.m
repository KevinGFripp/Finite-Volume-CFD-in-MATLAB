function [Lx,bx_bc] = Laplacian_Nonuniform_Dirichlet(Nx,dx_centre,dx,left,right)
...
CoefficientMatrix = zeros(2,2);
 ...
 CoefficientMatrix(2,:) =[2*stencil(1) stencil(2)].^2;
...
CoefficientMatrix = zeros(2,2);
 ...
 CoefficientMatrix(1,:) =[-stencil(1) -stencil(2)];
 CoefficientMatrix(2,:) =[stencil(1) 2*stencil(2)].^2;
