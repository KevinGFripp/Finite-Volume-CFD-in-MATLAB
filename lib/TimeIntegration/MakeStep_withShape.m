function [uvector,vvector] = MakeStep_withShape(uvector,vvector, ...
  ...
  [uprime_divergence,vprime_divergence] = ...
  ApplyVelocityShapeBoundaries(uprime_divergence,vprime_divergence, ...
                               Shape,Mesh.Nx,Mesh.Ny);
